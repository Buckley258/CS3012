 ...
 * about its downloads for each "release" of the project.
 * then display the amount of downloads each release had as a percentage of total downloads
...
public class API {
	public static void main(String[] args) throws Exception {
		...
		// create pie chart
		CreateChart pieChart = new CreateChart("Social Pie Chart", "Percentage Of Downloads For Each Release From Total Downloads ("+ sum + ")", dArray, total);
		pieChart.pack();
